...
export default function PrivacyPolicy() {
  ...
  function Heading1({ children }: ChildrenProps) {
    return (
      <h1 className="text-h1 text-main-darkpurple font-semibold mb-[16px] font text-[32px]">
        {children}
      </h1>
    );
  }
  ...
  function BodyText({ children }: ChildrenProps) {
    return (
      <p className="my-[18px] text-body text-main-grey font-medium">
        {" "}
        {children}{" "}
      </p>
    );
  ...
  function Heading3({ children }: ChildrenProps) {
    return (
      <h3 className="mt-[20px] mb-[10px] text-h3 font-semibold text-main-darkpurple">
        {children}
      </h3>
    );
  }
