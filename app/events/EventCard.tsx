            ...
            <div className="w-75 p-2 relative h-55">
                <Link href={`/events/${props.name}`}>
                    ...
                    <div className="flex flex-col absolute w-17 aspect-square pt-1 bg-white top-2 right-2 text-secondary-grey">
                        <p className="text-center text-body-small">{props.event.startDate.toLocaleString("default", { month: "short"}).toUpperCase()}</p>
                        <p className="text-center text-h2">{props.event.startDate.getDate()}</p>
                    </div>
                </Link>
                ...
                <PageContent pageLayout={
                    [
                        ...
                        },
                        {
                            ...
                            content: (
                                <>
                                    {props.event.startDate.toDateString()}<br />
