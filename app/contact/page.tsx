    ...
    <div className="bg-white">
      ...
      <div className="place-self-center max-w-[1020px] mx-[168px] px-[32px] py-[96px] bg-white ">
        ...
        <div className="grid grid-cols-3 auto-rows-min py-[17px] gap-[34px]">
          ...
          <div>
            <p className="bodyText mt-[0px]"> Phone: <a href="tel:519-685-3500" className="text-link-blue">519-685-3500</a> </p>
            <p className="bodyText"> Toll Free: <a href="tel:1-800-966-0631" className="text-link-blue">1-800-966-0631 </a></p>
            <p className="bodyText"> Fax: <a href="tel:519-685-3549" className="text-link-blue">519-685-3549 </a></p>
            <p className="bodyText mb-[0px]"> E-mail: <a href="mailto:info@childcan.com" className="text-link-blue">info@childcan.com </a></p>
          </div>
        </div>
        ...
        <div className="py-[17px]">
          <div className="flex gap-2 items-center group">
            <SocialIcons
                ...
                path= {<path d="M113,145c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S254.4,145,113,145z M169.5,357.6l-2.9,38.3h-39.3 v133H77.7v-133H51.2v-38.3h26.5v-25.7c0-11.3,0.3-28.8,8.5-39.7c8.7-11.5,20.6-19.3,41.1-19.3c33.4,0,47.4,4.8,47.4,4.8l-6.6,39.2 c0,0-11-3.2-21.3-3.2c-10.3,0-19.5,3.7-19.5,14v29.9H169.5z"></path> }
            ></SocialIcons>
            <SocialIcons
                name="linkedin"
                ...
                colour="[#222]"
                viewbox="-143 145 512 512"
                path={<path d="M113,145c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S254.4,145,113,145z M41.4,508.1H-8.5V348.4h49.9 V508.1z M15.1,328.4h-0.4c-18.1,0-29.8-12.2-29.8-27.7c0-15.8,12.1-27.7,30.5-27.7c18.4,0,29.7,11.9,30.1,27.7 C45.6,316.1,33.9,328.4,15.1,328.4z M241,508.1h-56.6v-82.6c0-21.6-8.8-36.4-28.3-36.4c-14.9,0-23.2,10-27,19.6 c-1.4,3.4-1.2,8.2-1.2,13.1v86.3H71.8c0,0,0.7-146.4,0-159.7h56.1v25.1c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z "></path> }
            ></SocialIcons>
            <SocialIcons
                name="instagram-new"
